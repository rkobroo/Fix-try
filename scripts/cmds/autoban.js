...
module.exports = {
    ...
    onChat: async function ({ args, usersData, message, event, prefix, getLang }) {
        ...
        const sensitiveWords = ["chutiya bot", "bot mc", "bot chutiya", "bot muji", "madarchod bot", "bot ki maa ka bhosda", "bot bhosdike", "gandu bot", " bot fuck u", "bot mugi", "stupid bots lol", "chutiya bot ko admin", "chakka bot", "fuck bots", "dmm bot", "dam bot", "khate ko cho", "lado bot", "crazy bots", "khate bot", "tero bau khate", "bot lado chus", " lado kha bot", "bot nibba", "tero aama ko puti", "cmm bot", "clap bot", "bot ncc", "bot fuck you", "bot óc", "randi ko choro", "cc bot", "bot ko condo", "mg bot", "lol bot", "loz bot", "lồn bot", "fuck bot", "bot lon", "bot mugi", "bot lado kha", "bot lado chus", "bot randi", "bhosdike bot", "bot chutiye", "bot fake", "madarchod", "bot shoppee", "bad bots", "randi ko choro bot", "etc"];
