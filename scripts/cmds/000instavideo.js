...
const usernames = [
  "hottopicxpert","geniuspkvirat","kohlisxlove","cricket._bestcatches",
...
module.exports = {
  config: {
    name: "cricketvideo", // name your cmd
    aliases: ["cv"], // add aliases if need otherwise make it []
    author: "Vex_Kshitiz",// dont change this sar
    version: "1.0",
